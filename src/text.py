...
class Text:
    ...
    def set_custom_end(self, score: int, design: Design) -> None:
        ...
        thousand = Math.floor(score_final / 1000)
        hundred = Math.floor((score_final % 1000) / 100)
        ten = Math.floor((score_final % 100) / 10)
        unit = score % 10
        space = 12
