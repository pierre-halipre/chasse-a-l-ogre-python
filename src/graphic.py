...
from tool import Window
from design import Design
from sizes import Sizes
from rasters import GraphicCaption
from rasters import GraphicFrame
from rasters import GraphicMenu
from rasters import GraphicGame
...
class Graphic:
    def __init__(self, w_screen: int, h_screen: int) -> None:
        ...
        w_window = self.sizes.w_case * 8 + 2 * self.sizes.h_case
        h_window = self.sizes.h_case * 22
    ...
    def show_loading(self) -> None:
        image_icon = self.get_image_loading("loading_icon")
