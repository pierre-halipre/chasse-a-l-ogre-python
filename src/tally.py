...
class Tally:
    ...
    def update_score(self, monster: Monster) -> None:
        ...
        accuracy_update = accuracy_monster * (1 - self.sequence)
        accuracy_current = self.accuracy * self.sequence
        self.accuracy = accuracy_current + accuracy_update
        self.sequence = 1 / (2 - self.sequence)
